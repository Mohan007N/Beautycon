    ...
    <>
      <PageTitle title="Appointments" sub="Every booking across chairs, rooms and stylists.">
        <button
          ...
          className="flex items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground shadow-sm hover:scale-[1.02] transition-transform cursor-pointer"
        >
