...
export const services = [
  { id: "S-1", name: "Precision Haircut & Styling", category: "Hair", price: 1400, duration: 60, bookings: 312, image: "/images/balayage.png", description: "Precision haircut, blowout & signature finish." },
  { id: "S-2", name: "Botanical Hair Spa", category: "Hair", price: 1200, duration: 60, bookings: 268, image: "/images/hair_spa.png", description: "Deep botanical nourishment & scalp massage." },
  { id: "S-3", name: "24K Gold Radiance Facial", category: "Skin", price: 2400, duration: 75, bookings: 194, image: "/images/gold_facial.png", description: "24K radiance skin therapy & lymphatic drainage." },
  { id: "S-4", name: "French Balayage & Gloss", category: "Colour", price: 5600, duration: 120, bookings: 88, image: "/images/balayage.png", description: "Sun-kissed hand-painted highlights & gloss toner." },
  { id: "S-5", name: "Swedish Full Body Massage", category: "Massage", price: 3200, duration: 60, bookings: 142, image: "/images/gold_facial.png", description: "Therapeutic full body aromatherapy massage & tension release." },
  { id: "S-6", name: "Gel Polish Manicure", category: "Nails", price: 900, duration: 45, bookings: 241, image: "/images/gel_manicure.png", description: "Long-lasting gel polish, cuticle care & hand massage." },
  { id: "S-7", name: "Executive Beard Sculpting", category: "Grooming", price: 650, duration: 30, bookings: 156, image: "/images/beard_sculpt.png", description: "Precision barber razor trim, hot towel & beard oil." },
  { id: "S-8", name: "Keratin Smooth Treatment", category: "Hair", price: 4500, duration: 90, bookings: 110, image: "/images/hair_spa.png", description: "Intense frizz control & silk shine treatment." },
];
